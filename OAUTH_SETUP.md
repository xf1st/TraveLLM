...
- Проверьте, что redirect URI в Google OAuth совпадает с тем, что использует Supabase
- Убедитесь, что протокол (http/https) совпадает

### Ошибка "invalid_client"
- Проверьте правильность Client ID и Client Secret
- Убедитесь, что OAuth включен в Supabase

### Ошибка "access_denied"
- Проверьте, что ваш email добавлен в Test users
