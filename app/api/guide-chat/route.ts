...
`
        ...
        if (mode === 'global') {
            systemPrompt = `Ты — профессиональный, дружелюбный и эрудированный ИИ-ассистент. Ты сопровождаешь путешественника.
${realityContext}
...
Пользователь спрашивает о маршруте в целом: "${message}"`
            ...
            // Local mode
            systemPrompt = `Ты — профессиональный, дружелюбный и эрудированный ИИ-ассистент. Ты сопровождаешь путешественника в реальном времени.
