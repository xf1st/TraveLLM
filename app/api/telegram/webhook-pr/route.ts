  ...
  const res = await fetch('https://api.deepseek.com/chat/completions', {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: 'system',
          content: `Ты SMM-копирайтер сервиса TraveLLM.

TraveLLM — AI-сервис для планирования путешествий. Пользователь описывает куда хочет поехать, сервис генерирует готовый маршрут по дням с активностями, отелями, едой и советами. Есть интерактивные карты, AI-чат с гидом, совместное планирование с друзьями. Сайт: travellm.ru
